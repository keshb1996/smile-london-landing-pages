        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden md:block">
            <div className="relative rounded-2xl overflow-hidden shadow-dental-lg">
              <img src="/all-on-4-maria-hero-latest.png" alt="Happy patient with beautiful smile after All-on-Four dental implants" className="w-full h-[600px] object-cover object-top" />
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl p-6 shadow-dental-lg max-w-sm">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                "I came to Smile London and had the whole thing <span className="text-primary font-bold text-base relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-1 after:bg-gradient-to-r after:from-primary after:via-yellow-400 after:to-primary after:shadow-sm after:rounded-full">done in 1 day</span> really, and I'm just really happy with it!"
              </p>
            </div>
          </div>
        </div>

        ...
        <div className="dental-section">
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center text-white">
              ...
              <p className="text-gray-100 mb-3">Leading Invisalign Specialist</p>
            ...
            <div className="text-center text-white">
              ...
              <p className="text-gray-100 mb-3">State-of-the-Art Facility</p>
              <p className="text-sm text-gray-400">
            ...
            <div className="text-center text-white">
              ...
              <p className="text-gray-100 mb-3">3D Digital Scanning</p>
              <p className="text-sm text-gray-400">

    ...
    <section className="bg-dental-black">
      <div className="dental-section">
        <div className="text-center mb-16">
          <h2 className="dental-heading text-white mb-6">
            Why Choose Elite Dental for Your Invisalign Treatment?
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="text-center text-white">
            <div className="relative mb-6">
              <img 
                src={dentistImage} 
                alt="Dr. Sarah Johnson, Lead Invisalign Specialist"
                className="rounded-2xl mx-auto w-64 h-64 object-cover shadow-dental-lg"
              />
            </div>
            ...
            <p className="text-sm text-gray-400">
              15+ years experience, certified Invisalign provider with over 500 successful cases
            </p>
          </div>
          ...
          <div className="text-center text-white">
            <div className="relative mb-6">
              <img 
                src={clinicImage} 
                alt="Elite Dental modern clinic interior"
                className="rounded-2xl mx-auto w-64 h-64 object-cover shadow-dental-lg"
              />
            </div>

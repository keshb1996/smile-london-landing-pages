      ...
      <div className="dental-section">
        ...
        <div className="max-w-4xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="bg-dental-gray rounded-lg px-6 border-none">
            ...
            <div className="bg-dental-gray rounded-2xl p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <div className="text-center">
                  <p className="font-semibold">Call: 020 4540 1566</p>
